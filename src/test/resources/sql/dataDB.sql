...
-- Sales
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0001','John', 'Doe', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Sales'), 'Sales Rep', '2020-01-15', 50000, '123-456-7890', 'john.doe@example.com', 0);
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0002','Jane', 'Smith', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Sales'), 'Sales Rep', '2019-03-10', 52000, '123-456-7891', 'jane.smith@example.com', 0);
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0003','Alice', 'Johnson', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Sales'), 'Sales Rep', '2018-06-05', 53000, '123-456-7892', 'alice.johnson@example.com', 0);
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0004','Bob', 'Williams', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Sales'), 'Sales Manager', '2017-09-20', 54000, '123-456-7893', 'bob.williams@example.com', 0);
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0005','Charlie', 'Brown', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Sales'), 'Sales Rep', '2021-11-10', 55000, '123-456-7894', 'charlie.brown@example.com', 0);

-- Administration
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0006','David', 'Lee', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Administration'), 'Admin Manager', '2016-04-30', 60000, '123-456-7895', 'david.lee@example.com', 0);
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0007','Emily', 'Clark', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Administration'), 'Admin', '2017-08-15', 61000, '123-456-7896', 'emily.clark@example.com', 0);

-- Production
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0008','Frank', 'Lewis', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Production'), 'Production Manager', '2018-12-25', 48000, '123-456-7897', 'frank.lewis@example.com', 0);
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0009','Grace', 'Adams', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Production'), 'Worker', '2019-05-10', 42000, '123-456-7898', 'grace.adams@example.com', 0);
INSERT INTO Employee (employeeid, FirstName, LastName, DepartmentID, Title, HireDate, Salary, Phone, Email, version) VALUES ('uuid_e0010','Harry', 'Nelson', (SELECT DepartmentID FROM Department WHERE DepartmentName = 'Production'), 'Worker', '2020-03-20', 43000, '123-456-7899', 'harry.nelson@example.com', 0);
